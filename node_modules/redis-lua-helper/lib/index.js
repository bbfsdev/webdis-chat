...
// get the number of KEYS[]s of a lua script
ScriptHelper.prototype.keys = function (scriptName) {
	if (typeof this._keys[scriptName] !== 'undefined')
		return this._keys[scriptName];
	throw new Error('Script "' + scriptName + '" has not been loaded yet.');
};
